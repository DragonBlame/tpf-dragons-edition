...
Select _Profiles_ option from the Mod Organizer 2 (MO2) menu, select _The Phoenix Flavour_ profile and then _Copy_ on the right side and 
then name the copied profile `The Phoenix Flavour - Dragon’s Edition`.
...
just a bunch of ordinary thieves united in one gang.*
...
kill our improved vanilla or new followers. Win-win situation for me.*
...
**Old files** - BriDO - Cannibal Draugr Patch
...
<p align="center">
    <img width="35%" src="https://user-images.githubusercontent.com/37147270/151668655-ffe48bd2-b037-4b49-bbb2-08fdb3fa1852.png" /> 
</p>
...
* **ENB has the same hotkeys as TPF** - `F10` button toggles the ENB effect, `F11` opens the ENB GUI, `F7` toggles an FPS counter. Feel free to make screenshots with Steam by using `F12`.
...
>   Can be found on the first separator for WJ users.  

*   Screenshot or video of the problem if appliable;
   
>   Copy and paste in the report or just use any kind of picture/video sharing service etc. (when the problem is seeable, open the console (*\~* key) and press on the
