...
so there isn't even a point in maintaining the performance changes for me and considering many people, who struggle with performance already, use just TPF or something even lighter. And especially considering the exterior changes. Of course, you can make the changes to performance and DynDOLOD by yourself, but 
don't ask for advice on these ones in support channels.
